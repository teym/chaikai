<template>
  <div class="app-container">
    <div class="filter-container">
      <el-select v-model="listQuery.searchType" size="mini" style="width: 90px" class="filter-item">
      ...
      >
        ...
        <el-option v-for="(item, i) in channels" :key="i" :value="item.id" :label="item.name" />
      </el-select>
    ...
    <pagination
      ...
      @pagination="getList"
    />
    <el-dialog width="60%" title="达人详情" :visible.sync="detailVisable" append-to-body>
      <div v-if="detail" class="detail">
        ...
        <el-table :data="detail.channels" border fit>
          ...
          <el-table-column label="主页截图" align="center">
            <template slot-scope="{ row }">
              <el-button size="mini" @click="onPreview(row.homePic)">查看</el-button>
            </template>
          </el-table-column>
          <el-table-column label="操作" align="center">
            <template slot-scope="{ row }">
      ...
      <el-dialog width="60%" title="钱包明细" :visible.sync="financeVisable" append-to-body>
        <el-table v-loading="finance.loading" :data="finance.list" border fit style="width: 100%">
