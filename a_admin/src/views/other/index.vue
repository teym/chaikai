<template>
  <div class="app-container">
    <div class="filter-container">
      <h3 class="filter-item" style="margin-top: 0; line-height: 28px">
        轮播图
      </h3>
      <el-button
        class="filter-item"
    ...
    >
      ...
      <el-table-column label="轮播图" align="center" style="width: 160">
        <template slot-scope="{ row }">
      ...
      <div v-if="detail" class="detail">
        <div class="row">
          ...
          <div>
            <Upload
              ...
              :count="7"
              :limit="conf.limit"
              tip="686*400像素，支持PNG,JPG格式，小于5M"
            />
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          ...
          <div>
            ...
            <a href="https://docs.qq.com/doc/DU29Tb3NiYm9GRnBJ" target="_blank">《如何配置小程序跳转链接》</a>
          </div>
        </div>
        <div class="row">
          <h4>轮播排序:</h4>
