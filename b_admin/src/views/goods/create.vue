    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      <div class="createPost-main-container">
        ...
        <el-form-item style="margin-bottom: 30px;" label-width="90px" label="活动名称:">
          <el-input v-model="postForm.link" placeholder="活动名称"></el-input>
        </el-form-item>
        <el-form-item style="margin-bottom: 30px;" label-width="90px" label="报名时间:">
          <el-input v-model="postForm.price" placeholder="报名时间"></el-input>
        </el-form-item>
        <el-form-item style="margin-bottom: 30px;" label-width="90px" label="活动名额:">
          <el-input v-model="postForm.price" placeholder="活动名额"></el-input>
        </el-form-item>
      ...
      <div>
        ...
        <el-form-item style="margin-bottom: 30px;" label-width="90px" label="私密活动:">
          <el-input v-model="postForm.link" placeholder="私密活动"></el-input>
        </el-form-item>
        <el-form-item style="margin-bottom: 30px;" label-width="90px" label="收货地限制:">
          <el-input v-model="postForm.link" placeholder="收货地限制"></el-input>
        </el-form-item>
      </div>
      <div>
        <p>合作任务</p>
