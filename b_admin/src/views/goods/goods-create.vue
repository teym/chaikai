    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      <div class="createPost-main-container">
        ...
        <el-form-item style="margin-bottom: 30px;" label-width="90px" label="商品价值:">
          <el-input v-model="postForm.link" placeholder="请输入产品价值">
            <span slot="suffix">$</span>
          </el-input>
        </el-form-item>
        <el-form-item style="margin-bottom: 30px;" label-width="90px" label="商品名称:">
          <el-input v-model="postForm.link" placeholder="请输入商品名称" maxlength="10" show-word-limit>
          </el-input>
        </el-form-item>
        <el-form-item prop="image_uri" style="margin-bottom: 30px;" label-width="90px" label="商品头图:">
